...
//                                 <li className="mb-4">
//                                     <a
//                                         href="https://github.com/abhishek2005git"
...
export default function Footer() {
    return (
        <footer className="bg-white dark:bg-gray-800 border-y border-t-4 border-blue-200 dark:border-gray-700">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link to="/" className="flex items-center">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 dark:text-gray-200 uppercase">Resources</h2>
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 dark:text-gray-200 uppercase">Follow us</h2>
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a
                                        href="https://github.com/abhishek2005git"

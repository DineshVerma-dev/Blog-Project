...
const BlogCard = ({ blog, handleEdit, handleDelete, handleViewBlog }) => (
  <div
    className="max-w-sm rounded overflow-hidden shadow-lg bg-white m-4 transform hover:scale-105 transition-transform duration-300 ease-in-out cursor-pointer"
    onClick={() => handleViewBlog(blog)}
  >
    <div className="px-6 py-4">
      <h2 className="font-bold text-xl mb-2">{blog.title}</h2>
      <div className="text-gray-700 mb-4 line-clamp-3" dangerouslySetInnerHTML={{ __html: blog.content }} />
    </div>

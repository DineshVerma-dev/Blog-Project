  ...
  return (
    <div className="dark:bg-gray-900 dark:text-white">
      <div className="relative isolate px-4 pt-12 sm:px-6 lg:px-8"> {/* Reduced padding for mobile */}
        ...
        <div className="mx-auto max-w-4xl pb-10 sm:py-38 lg:py-46"> {/* Adjusted max-width for better responsiveness */}
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 dark:text-gray-300 text-gray-600 ring-1 dark:ring-gray-700 ring-gray-900/10 hover:ring-gray-900/20">
              Announcing our next round of funding.{' '}
              <Link
                to='team'
          ...
          <h1 className="text-4xl font-bold tracking-tight dark:text-white text-gray-900 sm:text-6xl lg:text-8xl"> {/* Adjusted for different screen sizes */}
            <span style={{ fontSize: '3rem', fontWeight: 'bold', color: "blueviolet", fontFamily: "Arial, sans-serif" }} className='text-6xl sm:text-7xl lg:text-9xl'>
              {Animation}
              <Cursor />
            </span> {/* Larger on bigger screens */}
          ...
          <div>
            <h2 className="text-lg sm:text-2xl lg:text-4xl font-sans font-bold tracking-tight dark:text-gray-300 text-gray-900">
              A place to read, write, and deepen your understanding
            </h2>
          </div>

          <div className="text-center">
            <p className="mt-6 text-base sm:text-lg leading-8 dark:text-gray-400 text-gray-600">
              "The best advice I ever got was that knowledge is power and to keep reading." – David Bailey
              Continual reading empowers us with knowledge, reinforcing the idea that learning is a lifelong endeavor that builds strength.
            </p>
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-x-6 gap-y-4 sm:gap-y-0">
              <Link
                to="signup"
                className="rounded-md bg-indigo-600 dark:bg-indigo-500 px-4 py-2 text-sm font-semibold dark:text-gray-200 text-white shadow-sm hover:bg-indigo-500 dark:hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Get started
              </Link>
              <Link
                to="team"
                className='text-sm font-semibold leading-6 dark:text-gray-300 text-gray-900'
              >
                Learn more <span aria-hidden="true">→</span>
              </Link>
            </div>
        ...
        >
          <div
           ...
           // className="relative left-[calc(50%+2rem)] aspect-[1155/678] w-[28.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 dark:opacity-40 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
          />
        </div>
      </div>
    </div>
